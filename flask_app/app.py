...
@server.route('/report/cvr/<int:days>', methods=['GET'])
...
@server.route('/report/cvr/compare-periods/<int:days>', methods=['GET'])
...
@server.route('/report/cvr/compare-periods/device/usertype/<int:days>', methods=['GET'])
...
@server.route('/report/cvr/<int:days>/csv', methods=['GET'])
...
@server.route('/report/userprofile/<int:id>', methods=['GET'])
